        ...
        <div>
          ...
          <div className="max-w-4xl">
            <p className="text-sm lg:text-base font-normal text-secondary mt-4">
              Hey there, I&apos;m Shivam Goswami - a passionate developer, avid
              writer, and a connoisseur of awesome design and development.
              Welcome to my corner of the digital world!
            </p>
            <p className="text-sm lg:text-base font-normal text-secondary mt-4">
              Since the early days of my journey, My acadmic backgroud was
              mechanical engineering but i have an strong interest about the
