  ...
  return (
    <>
      ...
      <nav className=" hidden px-6 z-[100] py-10 bg-neutral-100 lg:w-[15%] border-r border-neutral-200/[0.8] fixed top-0 h-screen lg:relative  left-0 lg:flex flex-col justify-between max-w-[14rem]">
        ...
        <a className="bg-slate-900 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block">
